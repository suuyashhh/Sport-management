<%@ Page Title="" Language="C#" MasterPageFile="~/ADMINPNAL/Admin.Master" AutoEventWireup="true" CodeBehind="IndividualAdmin.aspx.cs" Inherits="Sport_management.ADMINPNAL.IndividualAdmin" %>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Individual Event</li>
            </ol>
        </nav>
    </div>
