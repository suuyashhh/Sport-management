<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="Sport_management.Group" %>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card yashh mb-3" style="background-color: #21252C!important;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h3 class=" text-center" style="color: white;">Group Sport Registration</h3>
                                    </div>
                                    ...
                                    <div class="row g-3 needs-validation" novalidate="">
                                        ...
                                        <div class="col-12" style="margin-top: 40px">
                                            <div class="input-box">
                                                <asp:TextBox runat="server" ID="txtname" MaxLength="16" ToolTip="Maximum 16 Characters" placeholder="Enter Your Team Name" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-12">
                                            <div class="input-box">
                                                <asp:TextBox runat="server" ID="txtemail" placeholder="Enter Anyones Email" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-12">
                                            <div class="input-box">
                                                <asp:TextBox runat="server" ID="txtcontact" placeholder="Enter Anyones Contact No." CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-12">
                                            <div class="input-box">
                                                <asp:TextBox runat="server" ID="txtmsg" TextMode="MultiLine" Rows="5" placeholder="Enter Your Teamates Names*" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
    ...
    <script>
        function valid() {
            ...
            if (fileUpload.files.length === 0) {
                swal("Please Upload Payment SS", "", "error");
                return false;
            }
